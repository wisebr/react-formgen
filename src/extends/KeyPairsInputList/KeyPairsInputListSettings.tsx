...
import { DisabledSetting, HelpTipSetting, LabelSetting, NameSetting, RequiredSetting } from '../../settings/options';

const KeyPairsInputListSettings: React.FC<BaseSettingProps> = ({
  data,
  onUpdateElement,
}) => {
...
export default KeyPairsInputListSettings;
